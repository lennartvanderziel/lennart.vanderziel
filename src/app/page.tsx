      ...
      <section id="story" style={{ maxWidth: 1180, margin: "0 auto", padding: "110px 32px" }}>
        <div className="flex-wrap-col" style={{ display: "flex", gap: 64, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 440px" }}>
            ...
            <p style={{ marginTop: 16, maxWidth: 520, fontSize: 17, lineHeight: 1.6, color: "#5f5a51" }}>Since then I&apos;ve worked with 100+ business owners on their strategy — and just as importantly, on who&apos;s around them and what state they&apos;re in. The right room and the right condition, mentally and physically, change everything.</p>
