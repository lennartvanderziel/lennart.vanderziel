...
const system = [
  { n: "1", title: "Assess", desc: "A full intake — including real health data. No guessing where you stand." },
  { n: "2", title: "Plan", desc: "A specific plan for your body and mind, built around your business." },
  { n: "3", title: "Coach", desc: "Ongoing 1-on-1 coaching. We measure, adjust, and keep raising the bar." },
];
      ...
      <section style={{ background: INK, padding: SEC }}>
        <div className="flex-wrap-col" style={{ maxWidth: 980, margin: "0 auto", display: "flex", gap: 48, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 420px" }}>
            ...
            <h2 style={{ marginTop: 12, fontSize: "clamp(26px,3.4vw,36px)", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-0.02em", color: "#fff" }}>Lennart van der Ziel</h2>
            ...
            <p style={{ marginTop: 18, fontSize: 16.5, lineHeight: 1.6, color: MUT_SOFT }}>
            ...
            <p style={{ marginTop: 12, fontSize: 16.5, lineHeight: 1.6, color: MUT_SOFT }}>
